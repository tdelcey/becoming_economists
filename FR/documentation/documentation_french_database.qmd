...
The [4_FR_cleaning_thesis_metadata.R](/scripts/cleaning_scripts/FR/4_FR_cleaning_thesis_metadata.R) script is designed to clean metadata information. Sudoc and these.fr sources gathered information inputted by various local institutions and individuals, leading to inconsistencies and errors. The script addresses several key challenges:
...
thesis_metadata %>% 
  ...
  filter(thesis_id %in% c(thesis_id[[7]], duplicates[[7]])) %>% 
  DT::datatable(
    rownames = FALSE,
    options = list(
      pageLength = 5,
